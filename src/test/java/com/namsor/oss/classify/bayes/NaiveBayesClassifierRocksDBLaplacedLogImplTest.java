...
import com.namsor.oss.classify.bayes.rocksdb.NaiveBayesClassifierRocksDBLaplacedLogImpl;
...
public class NaiveBayesClassifierRocksDBLaplacedLogImplTest {
    private static final String ROCKSDB_DIR = "/tmp/rocksdb";
    public NaiveBayesClassifierRocksDBLaplacedLogImplTest() {
    }
    ...
    public void testLearnClassifySample1() throws Exception {
        String[] cats = {YES, NO};
        NaiveBayesClassifierRocksDBLaplacedLogImpl bayes = new NaiveBayesClassifierRocksDBLaplacedLogImpl("tennis", cats, ROCKSDB_DIR, 1d, false);
    ...
    public void testLearnClassifySample2() throws Exception {
        ...
        NaiveBayesClassifierRocksDBLaplacedLogImpl bayes = new NaiveBayesClassifierRocksDBLaplacedLogImpl("sentiment", cats, ROCKSDB_DIR, 1, true);
