 ...
 * @author elian
 */
public class MainSample2LaplacedLog {
    ...
    public static final void main(String[] args) {
        try {
            ...
            NaiveBayesClassifierMapLaplacedLogImpl bayes = new NaiveBayesClassifierMapLaplacedLogImpl("sentiment", cats, 1, false);
...
// Here are is X(B,S) to classify.
            ...
            Logger.getLogger(MainSample2LaplacedLog.class.getName()).log(Level.SEVERE, null, ex);
        } catch (Throwable ex) {
            Logger.getLogger(MainSample2LaplacedLog.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
