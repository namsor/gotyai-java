...
/**
 * Simple example of Naive Bayes Classification (Sport / No Sport) with Laplace
 * smoothing inspired by
 * http://ai.fon.bg.ac.rs/wp-content/uploads/2015/04/ML-Classification-NaiveBayes-2014.pdf
 *
 * @author elian
 */
public class MainSample1LaplacedWeird {
    ...
    public static final void main(String[] args) {
        ...
        try {
            ...
            NaiveBayesClassifierMapLaplacedImpl bayes = new NaiveBayesClassifierMapLaplacedImpl("tennis", cats, 1, true);
...
// Here are is X(B,S) to classify.
            ...
            Logger.getLogger(MainSample1LaplacedWeird.class.getName()).log(Level.SEVERE, null, ex);
