...
import com.namsor.oss.classify.bayes.inmem.NaiveBayesClassifierMapLaplacedLogImpl;
 ...
 * @author elian
 */
public class MainSample1LaplacedLogVariantWeird2 {
    ...
    public static final String[][] data = {
        ...
        // a weird line
        {"Overcasted", "Hotter", "Normalified", "Weaker", "Maybe"},
    };
    ...
    public static final void main(String[] args) {
        ...
        try {
            ...
            NaiveBayesClassifierMapLaplacedLogImpl bayes = new NaiveBayesClassifierMapLaplacedLogImpl ("tennis", cats, 1, true);
...
// Here are is X(B,S) to classify.
            ...
            Logger.getLogger(MainSample1LaplacedLogVariantWeird2.class.getName()).log(Level.SEVERE, null, ex);
