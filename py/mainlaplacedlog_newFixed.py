...
likelyhoodOfYes=math.exp(math.log(gL_cA_Yes) - math.log(gL) + (math.log(gL_cA_Yes_fE_temp_is_Cool + alpha)-math.log(gL_cA_Yes_fE_temp + ( gL_fE_temp_count * alpha )) + math.log(gL_cA_Yes_fE_humidity_is_High + alpha)-math.log(gL_cA_Yes_fE_humidity + ( gL_fE_humidity_count * alpha )) + math.log(gL_cA_Yes_fE_outlook_is_Overcast + alpha)-math.log(gL_cA_Yes_fE_outlook + ( gL_fE_outlook_count * alpha )) + math.log(gL_cA_Yes_fE_wind_is_Strong + alpha)-math.log(gL_cA_Yes_fE_wind + ( gL_fE_wind_count * alpha )) + 0 ))
likelyhoodOfYesExpr=math.exp(math.log(9) - math.log(14) + (math.log(3 + 1.0 )-math.log(9 + ( 3 * 1.0 )) + math.log(3 + 1.0 )-math.log(9 + ( 2 * 1.0 )) + math.log(4 + 1.0 )-math.log(9 + ( 3 * 1.0 )) + math.log(3 + 1.0 )-math.log(9 + ( 2 * 1.0 )) + 0 ))
likelyhoodOfYesValue=0.011806375442739077
...
likelyhoodOfNo=math.exp(math.log(gL_cA_No) - math.log(gL) + (math.log(gL_cA_No_fE_temp_is_Cool + alpha)-math.log(gL_cA_No_fE_temp + ( gL_fE_temp_count * alpha )) + math.log(gL_cA_No_fE_humidity_is_High + alpha)-math.log(gL_cA_No_fE_humidity + ( gL_fE_humidity_count * alpha )) + math.log(gL_cA_No_fE_outlook_is_Overcast + alpha)-math.log(gL_cA_No_fE_outlook + ( gL_fE_outlook_count * alpha )) + math.log(gL_cA_No_fE_wind_is_Strong + alpha)-math.log(gL_cA_No_fE_wind + ( gL_fE_wind_count * alpha )) + 0 ))
likelyhoodOfNoExpr=math.exp(math.log(5) - math.log(14) + (math.log(1 + 1.0 )-math.log(5 + ( 3 * 1.0 )) + math.log(4 + 1.0 )-math.log(5 + ( 2 * 1.0 )) + math.log(0 + 1.0 )-math.log(5 + ( 3 * 1.0 )) + math.log(3 + 1.0 )-math.log(5 + ( 2 * 1.0 )) + 0 ))
likelyhoodOfNoValue=0.004555393586005833
# basicProbabilities : 
